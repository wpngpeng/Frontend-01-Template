...
def get_json(url, datas):
    my_headers = {
        ...
        "Referer": "https://www.lagou.com/jobs/list_%E5%89%8D%E7%AB%AF?city=%E5%B9%BF%E5%B7%9E&cl=false&fromSearch=true&labelWords=&suginput=",
        "Content-Type": "application/x-www-form-urlencoded;charset = UTF-8"
    }
    time.sleep(5)
    ses = requests.session()    # 获取session
    ses.headers.update(my_headers)  # 更新
    ses.get("https://www.lagou.com/jobs/list_%E5%89%8D%E7%AB%AF?city=%E5%B9%BF%E5%B7%9E&cl=false&fromSearch=true&labelWords=&suginput=")
    ...
    for job in info:
        ...
        for skill in job['skillLables']:
          information.append(skill) # 所需技能
...
def main():
    ...
    info_result = []
    title = ['岗位id', '城市', '公司全名', '福利待遇', '工作地点', '学历要求', '工作类型', '发布时间', '职位名称', '薪资', '工作年限', '所需技能']
